...
INSERT INTO Poseen VALUES (100, 13);
INSERT INTO Poseen VALUES (100, 3);
INSERT INTO Poseen VALUES (110, 1);
INSERT INTO Poseen VALUES (110, 2);
INSERT INTO Poseen VALUES (110, 4);
INSERT INTO Poseen VALUES (110, 6);
INSERT INTO Poseen VALUES (120, 11);
INSERT INTO Poseen VALUES (120, 3);
INSERT INTO Poseen VALUES (120, 19);
INSERT INTO Poseen VALUES (120, 5);
INSERT INTO Poseen VALUES (130, 4);
INSERT INTO Poseen VALUES (130, 10);
INSERT INTO Poseen VALUES (130, 18);
INSERT INTO Poseen VALUES (130, 19);
INSERT INTO Poseen VALUES (140, 20);
INSERT INTO Poseen VALUES (140, 1);
INSERT INTO Poseen VALUES (140, 8);
INSERT INTO Poseen VALUES (140, 14);
INSERT INTO Poseen VALUES (150, 1);
INSERT INTO Poseen VALUES (150, 2);
INSERT INTO Poseen VALUES (150, 3);
INSERT INTO Poseen VALUES (150, 10);
INSERT INTO Poseen VALUES (160, 17);
INSERT INTO Poseen VALUES (160, 16);
INSERT INTO Poseen VALUES (160, 15);
INSERT INTO Poseen VALUES (160, 11);
INSERT INTO Poseen VALUES (170, 1);
INSERT INTO Poseen VALUES (170, 4);
INSERT INTO Poseen VALUES (170, 6);
INSERT INTO Poseen VALUES (170, 14);
INSERT INTO Poseen VALUES (180, 9);
INSERT INTO Poseen VALUES (180, 12);
INSERT INTO Poseen VALUES (180, 13);
INSERT INTO Poseen VALUES (180, 19);
INSERT INTO Poseen VALUES (190, 11);
INSERT INTO Poseen VALUES (190, 15);
INSERT INTO Poseen VALUES (190, 3);
INSERT INTO Poseen VALUES (190, 6);
INSERT INTO Poseen VALUES (200, 11);
INSERT INTO Poseen VALUES (200, 15);
INSERT INTO Poseen VALUES (210, 12);
INSERT INTO Poseen VALUES (210, 4);
INSERT INTO Poseen VALUES (220, 2);
INSERT INTO Poseen VALUES (230, 14);
INSERT INTO Poseen VALUES (240, 15);
INSERT INTO Poseen VALUES (240, 11);
INSERT INTO Poseen VALUES (250, 2);
INSERT INTO Poseen VALUES (250, 13);
INSERT INTO Poseen VALUES (260, 17);
INSERT INTO Poseen VALUES (260, 11);
...
INSERT INTO Pasan VALUES (1800, 130, 4, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-09-14 ', '12:15:00'));
INSERT INTO Pasan VALUES (1100, 130, 4, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-01-30 ', '12:15:00'));
INSERT INTO Pasan VALUES (1300, 130, 4, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-06-21 ', '03:13:00'));
INSERT INTO Pasan VALUES (2100, 130, 4, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-08-22 ', '03:13:00'));
INSERT INTO Pasan VALUES (1600, 140, 4, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-09-14 ', '12:15:00'));
INSERT INTO Pasan VALUES (1100, 160, 7, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-01-30 ', '12:15:00'));
INSERT INTO Pasan VALUES (1400, 170, 7, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-06-21 ', '03:13:00'));
INSERT INTO Pasan VALUES (2100, 170, 7, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-08-22 ', '03:13:00'));
INSERT INTO Pasan VALUES (1100, 180, 8, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-01-30 ', '12:15:00'));
INSERT INTO Pasan VALUES (1300, 170, 7, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-06-21 ', '03:13:00'));
INSERT INTO Pasan VALUES (2100, 180, 8, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-08-22 ', '03:13:00'));
INSERT INTO Pasan VALUES (1700, 110, 3, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-04-25 ', '12:15:00'));
INSERT INTO Pasan VALUES (1700, 120, 2, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-07-15 ', '15:35:00'));
INSERT INTO Pasan VALUES (1800, 130, 3, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-03-29 ', '15:30:00'));
INSERT INTO Pasan VALUES (1700, 140, 4, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-12-31 ', '05:45:00'));
INSERT INTO Pasan VALUES (1700, 150, 4, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-04-08 ', '03:00:00'));
INSERT INTO Pasan VALUES (1200, 160, 7, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-01-03 ', '12:25:00'));
INSERT INTO Pasan VALUES (1700, 170, 7, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-10-17 ', '17:25:00'));
INSERT INTO Pasan VALUES (1100, 170, 8, CONCAT(YEAR(DATEADD(YEAR, -1, GETDATE())), '-12-31 ', '15:45:00'));
...
INSERT INTO Pasan VALUES (1100, 150, 3, CONCAT(CONVERT(char(10), DATEADD(DAY, -45, GETDATE()),126), ' 20:12:00'));
INSERT INTO Pasan VALUES (1200, 140, 3, CONCAT(CONVERT(char(10), DATEADD(DAY, -44, GETDATE()),126), ' 22:13:00'));
INSERT INTO Pasan VALUES (1300, 130, 3, CONCAT(CONVERT(char(10), DATEADD(DAY, -43, GETDATE()),126), ' 21:14:00'));
INSERT INTO Pasan VALUES (1400, 210, 4, CONCAT(CONVERT(char(10), DATEADD(DAY, -33, GETDATE()),126), ' 22:15:00'));
