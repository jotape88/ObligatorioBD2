...
INSERT INTO PASAN VALUES (1700, 110, 1, CONVERT (char(19), DATEADD(DAY, -360, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 120, 2, CONVERT (char(19), DATEADD(DAY, -300, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 130, 3, CONVERT (char(19), DATEADD(DAY, -250, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 140, 4, CONVERT (char(19), DATEADD(DAY, -220, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 150, 5, CONVERT (char(19), DATEADD(DAY, -200, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 160, 6, CONVERT (char(19), DATEADD(DAY, -180, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 170, 8, CONVERT (char(19), DATEADD(DAY, -160, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 180, 9, CONVERT (char(19), DATEADD(DAY, -140, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 190, 10, CONVERT (char(19), DATEADD(DAY, -110, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 200, 11, CONVERT (char(19), DATEADD(DAY, -80, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 210, 12, CONVERT (char(19), DATEADD(DAY, -50, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 220, 13, CONVERT (char(19), DATEADD(DAY, -40, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 230, 14, CONVERT (char(19), DATEADD(DAY, -20, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 240, 15, CONVERT (char(19), DATEADD(DAY, -15, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 250, 16, CONVERT (char(19), DATEADD(DAY, -10, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 260, 7, CONVERT (char(19), DATEADD(DAY, -1, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 270, 17, CONVERT (char(19), DATEADD(DAY, 1, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 280, 18, CONVERT (char(19), DATEADD(DAY, 10, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 290, 19, CONVERT (char(19), DATEADD(DAY, 25, GETDATE()),126));
INSERT INTO PASAN VALUES (1800, 150, 20, CONVERT (char(19), DATEADD(YEAR, -2, GETDATE()),126));
INSERT INTO PASAN VALUES (1700, 150, 20, CONVERT (char(19), DATEADD(YEAR, -5, GETDATE()),126));
